					...
					<div
						...
						style={{
							...
							animation: !this.props.animation
								? "initial"
								: `${styles.rotateA} ${this.props.animationSpeed}ms ease infinite alternate`
						}}
					></div>
					<p className={styles.wp_tips}>Please Rotate!</p>
				</div>
			</div>
		);
	}
...
ViewportRestrict.defaultProps = {
	display: false,
	text:
		"Silahkan buka di smartphone kamu atau putar smartphone kamu ke posisi vertical untuk visual yang lebih baik.",
	image: require("./scape.png").default,
	animation: true,
	animationSpeed: 1500,
